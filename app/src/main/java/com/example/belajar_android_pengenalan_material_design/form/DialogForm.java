            ...
            public void onClick(final View v) {
                ...
                if (TextUtils.isEmpty(_kode_gejala)){
                    ...
                    if(pilih.equals("tambah")){
                        ...
                        databaseReference.push().setValue(new Gejala(hashMap.get("key"), hashMap.get("kode_gejala"),
                                hashMap.get("nama_gejala"), Double.parseDouble(Objects.requireNonNull(hashMap.get("bobot_nilai_cf")))))
                        ...
                        databaseReference.child(key).setValue(new Gejala(hashMap.get("kode_gejala"), hashMap.get("nama_gejala"),
                                Double.parseDouble(Objects.requireNonNull(hashMap.get("bobot_nilai_cf")))))
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
